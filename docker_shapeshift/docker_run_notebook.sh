...
if [ "$#" != "2" ]; then 
  ...
  docker run -it -p $ip:8080 -p 7000-7010:7000-7010 --rm -v "$(pwd)/$2"":"/notebooks \
		shapeshift:$1 /bin/bash -c "cd /notebooks && jupyter notebook --ip 0.0.0.0 --port 8080 --allow-root --no-browser"
fi
